...
private final class ContentPane extends JPanel implements ItemListener {
...
}       // end of inner class ContentPane




private final class ConfigPane extends JPanel implements ActionListener {
   private static final long serialVersionUID = 1L;
   ...
   @Override public void actionPerformed(ActionEvent e)
{
      ...
      if (e.getActionCommand().equals(SAVE_ACTION)) {
         BeduCourse newcourse = null;
         if (my_course instanceof BeduCourse.StudentCourse) {
            newcourse = new BeduCourse.StudentCourse(name_field.getText(),jid_field
		  .getText());
          }
         else if (my_course instanceof BeduCourse.TACourse) {
            newcourse = new BeduCourse.TACourse(name_field.getText(),jid_field.getText(),
         ...
         r.addCourse(newcourse);
         BeduManageCoursesBubble.this.combo_box.addItem(newcourse);
         BeduManageCoursesBubble.this.combo_box.setSelectedItem(newcourse);
         ...
         try {
            ...
            r.removeCourse(newcourse);
            r.addCourse(my_course);
            
            BeduManageCoursesBubble.this.combo_box.removeItem(newcourse);
          }
       }
...
}       // end of inner class ConfigPane


}       // end of class BeduManageClassBubble
